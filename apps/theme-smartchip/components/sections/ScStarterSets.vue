  ...
  <section id="starter-sets" role="region" aria-labelledby="starter-sets-label" class="pt-16 pb-32">
    <div class="max-w-screen-2xl mx-auto px-6">
      ...
      <div class="grid gap-6 md:grid-cols-3">
        <article class="bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden flex flex-col"
          aria-label="Set 10">
          <div class="flex-1 flex flex-col px-6 pb-10">
            <div class="px-5 pb-0">
              <h3 class="text-center text-2xl font-bold mt-6">
                SC-Set 10
              </h3>
            </div>
            <div class="p-10 pb-0">
              <div class="relative pb-[100%]">
                <img src="https://cdn02.plentymarkets.com/ehe3e071agu5/frontend/sc-content/sc-set-10.webp" alt="Set mit 10 Smart Chips"
            ...
            <ul class="space-y-2 text-base text-gray-700">
              ...
              <li class="text-center">
                Starter-Set mit: <br><strong>1 x First Bonder</strong> <br><strong>1 x Builder L</strong> <br><strong>1
                  x Builder H</strong> <br><strong>1 x Finish</strong> <br><strong>1 x SC Pyramide</strong>
        ...
        <article class="bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden flex flex-col"
          ...
          <div class="flex-1 flex flex-col px-6 pb-10">
            ...
            <div class="p-10 pb-0">
              <div class="relative pb-[100%]">
                <img src="https://cdn02.plentymarkets.com/ehe3e071agu5/frontend/sc-content/sc-set-50.webp" alt="Set mit 50 Smart Chips"
                  class="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async">
              </div>
            </div>
            <hr class="mt-6 mb-4 border-gray-200">
        ...
        <article class="bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden flex flex-col"
          ...
          <div class="flex-1 flex flex-col px-6 pb-10">
            ...
            <div class="p-10 pb-0">
              <div class="relative pb-[100%]">
                <img src="https://cdn02.plentymarkets.com/ehe3e071agu5/frontend/sc-content/sc-set-200.webp" alt="Set mit 200 Smart Chips"
                  class="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async">
              </div>
            </div>
            <hr class="mt-6 mb-4 border-gray-200">
